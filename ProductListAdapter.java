...
import static com.meluha.monlashsolutions.meluha.R.id.imageView;
...
public class ProductListAdapter extends BaseAdapter {
    ...
    public ProductListAdapter(Activity context,List<ProductModel> products )
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View vie = layoutinflater.inflate(R.layout.single_product_list,null);
